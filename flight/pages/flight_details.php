                          ...
                          <div class="modal-content">
                            ...
                            <form id="rebookForm<?= htmlspecialchars($f_no) ?>" enctype="multipart/form-data" style="margin:0px !important;">
                              ...
                              <div class="modal-body" id="origin-destination<?= htmlspecialchars($routeVal) ?>" >
                                <div style="display: flex;margin-bottom:10px; margin-top:10px;">
                                  <label class="col-md-4" style="text-align:left;align-content: center;">Origin:</label>
                                  <input type="hidden" name="route[]" value="<?= htmlspecialchars($routeVal) ?>">
                                  <input class="col-md-8 departure" style="border-radius: 0px !important;" type="text" list="from" name="newOrigin[]" value="<?= $info['departure']?>">
                              ...
                              <div class="modal-body" id="destination<?= htmlspecialchars($routeVal) ?>">
                                <div style="display: flex;margin-bottom:10px;">
                                  <label class="col-md-4" style="text-align:left;align-content: center;">Destination:</label>
                                  <input type="hidden" name="route[]" value="<?= htmlspecialchars($routeVal) ?>">
                                  <input class="col-md-8 arrival" style="border-radius: 0px !important;" type="text" list="to" name="newDestination[]" value="<?= $info['arrival']?>">
                                  <?php //require_once($fl_root."/pages/destinations.php"); ?>
                                </div>
                              </div>
                              ...
                              <div class="modal-body">
                                <div style="display: flex; margin-bottom:10px;">
                                  ...
                                  <input type="hidden" name="routes[]" value="<?= htmlspecialchars($routeVal) ?>">
                                  <select class="form-control" name="initiate[]">
                    ...
                    <hr>
                        ...
                        <?php foreach ($routes as $route => $info): ?>
                            ...
                            <div style="margin-top: 10px;">
                                <p style="display:flex;gap:10px;">
                                  <strong>Route: <?= $route ?></strong>
                                  <strong>Date: <?= date('F j, Y', strtotime($info['rebookdate'])) ?></strong>
                                  <strong>Time: <?= date('h:i A', strtotime($info['rebooktime'])) ?></strong>
                                  <strong>New Price: ₱<?= number_format($info['rebookprice'], 2) ?? 0.00 ?></strong>
                                  <strong>Service Fee: ₱<?= number_format($info['rebookfee'], 2) ?? 0.00 ?></strong>
                                  <strong>Total: ₱<?= number_format($info['rebookprice']+$info['rebookfee'], 2) ?? 0.00 ?></strong>
                                  </p>
                            </div>
                        <?php endforeach; ?>
                        <?php } ?>
                        <?php if ($info['status'] == 'served' || $info['status'] == 'rebooked' && $info['r_status'] != 'rebooked') { ?>
                        ...
                        <div class="modal fade" id="Img<?= $info['ref'] ?>" tabindex="-1" role="dialog">
                                <div class="modal-dialog modal-lg" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h4 class="modal-title">Final Flight Booking</h4>
                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                <span aria-hidden="true">&times;</span>
                                            </button>
                                        </div>
                            ...
                            <?php foreach ($routes as $route): 
                                ...
                                <div style="margin-top: 10px;">
                                        <p style="display:flex;gap:10px;"> 
                                            ...
                                            <strong>Route: <?= htmlspecialchars($route['departure'] . ' - ' . $route['arrival']) ?></strong> 
                                            <strong>Date: <?= !empty($route['rebookdate']) ? date('F j, Y', strtotime($route['rebookdate'])) : 'N/A' ?></strong> 
                                            <strong>Time: <?= !empty($route['rebooktime']) ? date('h:i A', strtotime($route['rebooktime'])) : 'N/A' ?></strong>
                                            <strong>Total Price: ₱<?= number_format($route['rebookprice'] + $route['rebookfee'], 2) ?></strong>
                                        </p>
                        ...
                        <div class="modal fade" id="Img<?= $info['ref'] ?>" tabindex="-1" role="dialog">
                                <div class="modal-dialog modal-lg" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                          <img width="700" src="http://192.168.105.234/prosperityph/flightbooking/actions/uploads/<?= $info['r_attachment'] ?>">
                                        </div>
                                        <!-- <div class="modal-footer">
                                            <button type="button" class="btn btn-default waves-effect btn-mini" data-dismiss="modal">Close</button>
                                            <button type="button" class="btn btn-primary waves-effect waves-light btn-mini">Save changes</button>
