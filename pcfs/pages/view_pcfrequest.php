             ...
             <div class="third">
              <div class="table-container">
                <table class="table table-striped table-bordered nowrap">
                 ...
                 <?php 
                     if (!empty($replenish)) { 
                        foreach ($replenish as $k => $r) {
                          ...
                          if($r['dis_empno'] == $user_id && in_array($r['dis_status'], ['returned','f-returned','c-returned'])) {
                 ?>
                 ...
                 <?php }elseif ($r['dis_empno'] == $user_id && in_array($r['dis_status'] , ['h-approved','checked','f-approved','deposited'])) { ?>
                 <tr class="clickable-row" data-id="<?= $r['dis_no'] ?>" data-stat="<?= $r['dis_status'] ?>">
                     <td id="m">
                         <?php if (!empty($notif)) { foreach ($notif as $n) { ?>
                 ...
                 <?php }elseif ($r['dis_empno'] == $user_id && in_array($r['repl_status'] , ['h-approved','checked','f-approved','deposited']) && $r['dis_status'] == 'cancelled') { ?>
                 <tr class="clickable-row" data-id="<?= $r['dis_no'] ?>" data-stat="<?= $r['dis_status'] ?>">
                     <td id="m">
                         <?php if (!empty($notif)) { foreach ($notif as $n) { ?>
                         <i class="icon-bubble" style="font-size:14px;color: red;"> 
                 ...
                 <?php }elseif ($r['dis_empno'] == $user_id && in_array($r['repl_status'] , ['c-returned','f-returned']) && $r['dis_status'] == 'cancelled') { ?>
                 <tr class="clickable-row" data-id="<?= $r['dis_no'] ?>" data-stat="<?= $r['dis_status'] ?>">
                     <td id="m">
                         <?php if (!empty($notif)) { foreach ($notif as $n) { ?>
                         <i class="icon-bubble" style="font-size:14px;color: red;"> 
