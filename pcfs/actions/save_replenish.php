...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    try {
        ...
        $stmt = $pcf_db->prepare("INSERT INTO tbl_replenish 
             (repl_no, repl_custodian, repl_company, repl_outlet_dept, repl_outlet, repl_pending, repl_rrr, repl_cash_on_hand, repl_end_balance, repl_expense, repl_unrepl, repl_variance, repl_status, repl_date) 
             VALUES (:repl_no, :repl_custodian, :repl_company, :repl_outlet_dept, :repl_outlet, :repl_pending, :repl_rrr, :repl_cash_on_hand, :repl_end_balance, :repl_expense, :repl_unrepl, :repl_variance, :repl_status, :repl_date)");
