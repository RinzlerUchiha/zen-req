<?php
  ...
  class ATD
  {
      ...
      {
          $cont = new mysqli((getenv('ZEN_DB_HOST') ?: ""), "admin", "Administr@t0r", DB_ATD);
          return $cont;
      }
  }
  ...
  //     public static function mysqli()
  //     {
  //         $cont = new mysqli((getenv('ZEN_DB_HOST') ?: ""), "admin", "Administr@t0r", "demo_db_hr");
  //         return $cont;
  //     }
  // }
  ...
  class ZenDatabase
  {
      ...
      public static function mysqli()
      {
          $cont = new mysqli((getenv('ZEN_DB_HOST') ?: ""), "admin", "Administr@t0r", DB_ZEN);
          return $cont;
      }
  }
  ...
  class HRDatabase
  {
      ...
      public static function mysqli()
      {
          $cont = new mysqli((getenv('ZEN_DB_HOST') ?: ""), "admin", "Administr@t0r", DB_HRD);
          return $cont;
      }
  }
