...
// 		$hruid = $_SESSION['user_id'];
// 	}
// 	include("mysqlhelper.php");
// 	// $query = $mysqlhelper->query("SELECT $field FROM tbl_user2 JOIN tbl_sysassign ON asgd_user=U_ID WHERE asgd_system='HRIS' AND U_ID = '".$_SESSION['user_id']."'");
