...
$pending_training = count($arr['pending'] ?? []);
$confirmed_training = count($arr['approved'] ?? []);
$cancelled_training = count($arr['cancelled'] ?? []);
$denied_training = count($arr['denied'] ?? []);
?>
              ...
              <div class="col-lg-12 col-xl-12">
                ...
                <div class="header-fun">
                  <div class="sub-buttons">
                    <button type="button" class="btn btn-outline-primary btn-mini ml-auto batchapprove" id="batchApprove" data-reqtype="training">Approve selected</button>
                    ...
                    <button type="button" class="btn btn-outline-primary btn-sm m-1 btnadd" title="Add" data-toggle="modal" data-reqact="ADD" data-reqid="" data-reqemp="045-2017-068" data-reqchange="0" data-reqtype="training" data-target="#activitymodal"><i class="fa fa-plus"></i></button>
                  </div>
                  <div class="sub-date">
                ...
                <ul class="nav nav-tabs md-tabs" role="tablist">
                  <li class="nav-item">
                    <a class="nav-link active" data-toggle="tab" href="#pendingL" role="tab">Pending
                      <?php if ($pending_training > 0) {
                        echo '<span class="ml-1"><i class="badge badge-danger ml-1">'.$pending_training.'</i></span>';
                      }
                      ?>
                    </a>
                    <div class="slide"></div>
                  ...
                  <li class="nav-item">
                    <a class="nav-link" data-toggle="tab" href="#approvedL" role="tab">Approved
                      <?php if ($confirmed_training > 0) {
                        echo '<span class="ml-1"><i class="badge badge-danger ml-1">'.$confirmed_training.'</i></span>';
                      }
                      ?>
                    </a>
                    <div class="slide"></div>
                  ...
                  <li class="nav-item">
                    <a class="nav-link" data-toggle="tab" href="#cancelledL" role="tab">Cancelled
                      <?php if ($cancelled_training > 0) {
                        echo '<span class="ml-1"><i class="badge badge-danger ml-1">'.$cancelled_training.'</i></span>';
                      }
                      ?>
                    </a>
                    <div class="slide"></div>
                  ...
                  <li class="nav-item">
                    <a class="nav-link" data-toggle="tab" href="#deniedL" role="tab">Denied
                      <?php if ($denied_training > 0) {
                        echo '<span class="ml-1"><i class="badge badge-danger ml-1">'.$denied_training.'</i></span>';
                      }
                      ?>
                    </a>
                    <div class="slide"></div>
...
document.getElementById("btn-batch-decline").addEventListener("click", function () {
  ...
  document.getElementById("batch_cancel_deny_activity_type").value = "training";
});
