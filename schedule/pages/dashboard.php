            ...
            <div class="row">
                <div class="col-sm-3">
                    <div class="input-group input-group-default">
                        <span class="input-group-addon" style="background-color: #606061 !important">
                            Month
                        </span>
                ...
                <div class="col-sm-4">
                    <button class="btn btn-secondary btn-mini mb-1 ml-1" id="btnloadshed" type="button"><i class="fa fa-search"></i></button>
                </div>
            </div>
            <div class="row">
              ...
              <?php } ?>
              <div class="col-md-12">
                <div class="card card-lightblue card-outline" style="border-top: 4px solid rgba(0, 115, 170, 0.5);">
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form class="form-horizontal" id="form_sched">
              <div class="modal-body d-flex justify-content-between gap-3" style="padding: 10px !important;">
                  ...
                  <div class="col-md-7" >
                    ...
                    <div class="mt-3" style="display: flex;">
                      <label style="margin-right: 5px;">Work Days: <span class="text-info font-weight-normal">(Unselected days will be considered as <span class="text-danger">rest day</span>)</span></label>
                    ...
                    <div class="mt-3 d-none" style="display: flex;">
                    ...
                    <div class="mt-3" style="display: flex;gap:5px;">
                      <label style="margin-right: 5px;">Schedule Type:</label>
        ...
        <div class="modal-content">
            ...
            <form class="form-horizontal" id="form_esched">
              <div class="modal-body d-flex justify-content-between gap-3" style="padding: 10px !important;">
                <div class="col-md-12" >
                  <div style="display: flex;">
                    <label class="col-form-label col-sm-2" style="margin-right: 5px;">Name:</label>
                    <label class="col-form-label col-sm-2" id="lblschedemp">-</label>
                  </div>
                  <div style="display: flex;">
                    <label class="col-form-label col-sm-2" style="margin-right: 5px;">Date Range:</label>
                    <label class="col-form-label col-sm-2" id="lblschedemp">-</label>
                  </div>
                  <div class="mt-3" style="display: flex;gap:5px;">
                    <label class="col-form-label col-sm-2" style="margin-right: 5px;">FROM:</label>
                    <input type="date" class="form-control form-control-sm" id="eschedfrom" value="<?=date("Y-m-01")?>">
                    <label class="col-form-label col-sm-2" style="margin-right: 5px;">TO:</label>
                  ...
                  <div style="display: flex;gap:5px;">
                    <div id="esched_days_list" class="btn-group btn-group-toggle d-flex" data-toggle="buttons">
                      <label class="btn btn-sm btn-outline-primary"><input checked type="checkbox" class="esched_days" value="Sunday">Sun</label>
                      <label class="btn btn-sm btn-outline-primary"><input checked type="checkbox" class="esched_days" value="Monday">Mon</label>
                      <label class="btn btn-sm btn-outline-primary"><input checked type="checkbox" class="esched_days" value="Tuesday">Tue</label>
                      <label class="btn btn-sm btn-outline-primary"><input checked type="checkbox" class="esched_days" value="Wednesday">Wed</label>
                      <label class="btn btn-sm btn-outline-primary"><input checked type="checkbox" class="esched_days" value="Thursday">Thu</label>
                      <label class="btn btn-sm btn-outline-primary"><input checked type="checkbox" class="esched_days" value="Friday">Fri</label>
                      <label class="btn btn-sm btn-outline-primary"><input checked type="checkbox" class="esched_days" value="Saturday">Sat</label>
                    </div>
                  </div>
                  <div class="mt-3 d-none" style="display: flex;">
                    <div class="icheck-info">
                  ...
                  <div style="display: flex;">
                    <label class="col-form-label col-sm-2" style="margin-right: 5px;">Time Range:</label>
                  </div>
                  <div class="mt-3" style="display: flex;gap:5px;">
                    <label class="col-form-label col-sm-2" style="margin-right: 5px;">START:</label>
                    <input type="time" id="eschedstart" class="form-control form-control-sm" value="09:00">
                    <label class="col-form-label col-sm-2" style="margin-right: 5px;">END:</label>
                    <input type="time" id="eschedend" class="form-control form-control-sm" value="19:00">
                  </div>
                  <div class="mt-3" style="display: flex;">
                    <label class="col-form-label col-sm-2" style="margin-right: 5px;">Outlet:</label>
                  ...
                  <div class="mt-3" style="display: flex;gap:5px;">
                    <label class="col-form-label col-sm-2" style="margin-right: 5px;">Schedule Type:</label>
...
<script type="text/javascript">
  ...
  function setrd(e1) {
    if(confirm("Mark as Rest Day?")){
      $.post("schedule", { action: 'setrd', emp: $(e1).data('emp'), dt: $(e1).data('dt') }, function(res){
        if(res == 1){
  ...
  function delrd(e1) {
    if(confirm("Remove Rest Day?")){
      $.post("schedule", { action: 'delrd', emp: $(e1).data('emp'), dt: $(e1).data('dt') }, function(res){
        if(res == 1){
  ...
  function unlock(id1, type1) {
    if(confirm("Unlock this record?")){
      $.post("schedule", { action: 'unlock', id: id1 }, function(res){
        if(res == 1){
  ...
  function batch_unlock() {
    if(confirm("Unlock this record?")){
      ...
      $.post("schedule", { action: 'unlock', data: JSON.stringify(data) }, function(res){
        if(res == 1){
          alert("Record is unlocked");
          getsched('shift', '300px');
        }else{
  ...
  function removesched(id1, type1) {
    if(confirm("Remove schedule?")){
      $.post("schedule", { action: 'delsched', id: id1 }, function(res){
        if(res == 1){
