                  ...
                  <li class="header-notification">
								...
								<li class="header-notification">
        							...
        							<!-- <ul class="show-notification">
										...
										<li>
									    	<div class="media">
									    	   <img class="d-flex align-self-center" style="border-radius: 50%;width: 38px;height: 38px;" src="' . $imgSrc . '">
									...
									foreach ($mentions as $mention) {
									    ...
									    // Ensure datetime is parsed correctly with timezone awareness
												...
												<ul class="show-notification">
									             ...
									             <div class="media">
									                ...
									                <div class="media-body">
									                    ...
									                    <span class="notification-time">' . htmlspecialchars($time_ago) . '</span>
									                </div>
									             </div>
									          </li>
											</ul>';
								...
								<li class="user-profile header-notification">
									<a href="#!">
										<?php
										require_once($lv_root."/actions/get_profile.php");
                ...
                <div class="card card_main p-fixed users-main" style="background-color: white;">
                        ...
                        <div class="main-friend-list"><br>
                                	...
                                	<div>
                                		<img src="/zen/assets/img/directory.png" width="45" height="45"><br>Sales
																...
																<a class="media-left" href="/zen/so" style="text-align: center;">
																	<div>
																		<img src="/zen/assets/img/soDTR.png" width="45" height="45"><br>SO DTR
																	</div>
																</a>
																<a class="media-left" href="/zen/so-leave" style="text-align: center;">
																	<div>
																		<img src="/zen/assets/img/soLeave.png" width="45" height="45"><br>SO Leave
																	</div>
																</a>
																<a class="media-left" href="/zen/dtr/permission-slip" style="text-align: center;">
																	<div>
																		<img src="/zen/assets/img/prs.png" width="45" height="45"><br>PRS
																	</div>
																</a>
                            </div>
                            ...
                            <div class="media userlist-box" data-id="1" data-status="online" data-toggle="tooltip" style="text-align: center;">
                                ...
                                <a class="media-left" href="/zen/grievance" style="text-align: center;">
                                	<div>
                                	...
                                	<div>
                                		<img src="/zen/assets/img/persapp.png" width="45" height="45"><br>PA SJI
																...
																<a class="media-left" href="/zen/compliance/personnel-request-list" style="text-align: center;">
																	<div>
																		<img src="/zen/assets/img/prf.png" width="45" height="45"><br>PRF
																	</div>
																</a>
																<a class="media-left" href="/zen/compliance/pr" style="text-align: center;">
																	<div>
																		<img src="/zen/assets/img/prlist.png" width="45" height="45"><br>PR List
																	</div>
																</a>
                            </div>
