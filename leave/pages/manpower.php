...
<script type="text/javascript">
	...
	function loadmonth() {
		if($("#mpnav li a.active").attr('id') != 'calendar-tab' || ($("#mpnav li a.active").attr('id') == 'calendar-tab' && ($("#mpemp:visible").val() || $("#mpoutlet:visible").val() || ($("#divfilter:visible").length == 0 && $("#filteremp").val())))){
			...
			ajax1 = $.post("/hrisdtrservices/manpower/mp_data/load/",
				{
	...
	// --------------- gatepass
		...
		function getdtrlog(dt1) {
			if(dt1){
				...
				$.post("/hrisdtrservices/manpower/mp_data/load/", { load: "gpdtr", get_dtr: dt1 }, function(data){
					$("#dtrtable").html(data);
				});
			}else{
	...
	// --------------- notify
		function notify() {
			$.post("/hrisdtrservices/manpower/mp_data/load/", { load: "notify" }, function(data){
				var obj = JSON.parse(data);
