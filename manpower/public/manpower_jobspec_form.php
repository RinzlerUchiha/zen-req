...
$jsDepartments = $hr_db->query("SELECT Dept_Code, Dept_Name FROM tbl_department ORDER BY Dept_Name ASC")->fetchAll(PDO::FETCH_ASSOC);
$jsSections = $hr_db->query("SELECT sec_code, sec_name FROM tbl_section ORDER BY sec_name ASC")->fetchAll(PDO::FETCH_ASSOC);
$jsPositions = $hr_db->query("SELECT jd_code, jd_title FROM tbl_jobdescription ORDER BY jd_title ASC")->fetchAll(PDO::FETCH_ASSOC);
?>
<style>
    #mp-form-app {
        --mp-page-bg: #F5F6F9;
    ...
    <div class="page-body">
        <div class="container-fluid">
            <div class="mp-shell">
                ...
                <div class="mp-header">
                    <div>
                        <h1><?= $editing ? 'Edit Job Specification' : 'New Job Specification' ?></h1>
                        <p>Define the profile and competencies required for this role</p>
                    </div>
                ...
                <div class="mp-sticky-footer">
                    <a href="dashboard#job-spec" class="btn-mp-outline">Cancel</a>
...
$(function() {
    ...
    $tocLinks.on('click', function(e) {
        e.preventDefault();
        document.getElementById($(this).attr('href').substring(1)).scrollIntoView({ behavior: 'smooth', block: 'start' });
    });
    ...
    $('#jobspec-form').on('submit', function(e) {
            e.preventDefault();
