					...
					<table class="table" id="tbl-pa" style="width: 100%;">
						<thead>
							<tr>
								...
								<th style="border: 2px solid grey; text-align: center; vertical-align: middle; max-width: 80px; min-width: 80px; width: 80px;">% Attainment</th>
...
<?php } ?>
<script src="/zen/ckeditor/ckeditor.js"></script>
<script src="/zen/ckeditor/adapters/jquery.js"></script>
<script type="text/javascript">
	var pa_row=0;
