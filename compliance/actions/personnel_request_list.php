         ...
         <div class="card-body">
            <div class="col-lg-12 col-xl-12">
                <ul class="nav nav-tabs">
                  <li><a href="#disp-request-draft" id="personneltab-draft" data-toggle="tab" onclick="get_personnelreq('draft')">DRAFT</a></li>
                  <li class="active"><a href="#disp-request-pending" id="personneltab-pending" data-toggle="tab" onclick="get_personnelreq('pending')">PENDING</a></li>
                  <!-- <li><a href="#disp-request-reviewed" id="personneltab-reviewed" data-toggle="tab" onclick="get_personnelreq('reviewed')">REVIEWED</a></li> -->
                  <li><a href="#disp-request-approved" id="personneltab-approved" data-toggle="tab" onclick="get_personnelreq('approved')">APPROVED</a></li>
                  <li><a href="#disp-request-update" id="personneltab-update" data-toggle="tab" onclick="get_personnelreq('update')">REQUESTS UPDATE</a></li>
                  <li><a href="#disp-request-cancelled" id="personneltab-cancelled" data-toggle="tab" onclick="get_personnelreq('cancelled')">CANCELLED</a></li>
                  <li><a href="#disp-request-declined" id="personneltab-declined" data-toggle="tab" onclick="get_personnelreq('declined')">DECLINED</a></li>
                  <li><a href="#disp-jobspec" id="personneltab-jobspec" data-toggle="tab">JOB SPECIFICATION</a></li>
              </ul>
...
<script type="text/javascript">
  function get_personnelreq(stat){
    $("#disp-request").html("");
    $("#disp-request-"+stat).html("<center><img src='../../img/loading.gif'></center>");
