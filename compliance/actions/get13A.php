...
<div id="personal-info1" style="background-color: white; padding: 20px;">
     <div class="basic-info" style="display: flex;justify-content: space-between;">
       ...
       <a class="btn btn-primary btn-mini" style="width: 10%;" href="_13Acreate">create 13A</a>
     </div>
     <div class="basic-info">
        <div class="col-md-12">                                       
            ...
            <ul class="nav nav-tabs md-tabs" role="tablist">
                ...
                <li class="nav-item">
                    <a class="nav-link" data-toggle="tab" href="#cancel" role="tab">Cancelled</a>
                    <div class="slide"></div>
                </li>
            </ul>
            <!-- Tab panes -->
            <div class="tab-content card-block">
                ...
                <div class="card">
                    ...
                    <div class="table-container" id="_13draft">
                ...
                <div class="tab-pane active" id="pending" role="tabpanel"><br>
                    <div class="card">
                        <div class="card-block">
                        <div class="table-container" id="_13Aposted">
                            
                        </div>
                        </div>
                    </div>
                </div>
                <div class="tab-pane" id="checked" role="tabpanel"><br>
                    <div class="card">
                        <div class="card-block">
                        <div class="table-container" id="_13Achecked">
                ...
                <div class="tab-pane" id="reviewed" role="tabpanel"><br>
                    <div class="card">
                    <div class="card-block">
                    <div class="table-container" id="_13Areviewed">
     ...
     <div class="modal-dialog modal-lg" role="document">
         <div class="modal-content">
             <div class="modal-header">
                 <h4 class="modal-title">13A Form</h4>
