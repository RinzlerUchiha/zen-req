...
<div class="page-wrapper" style="min-height: 100vh; background-color: #f8f9fa;padding:20px;">
  ...
  <div class="page-body">
          ...
          <div class="card-block tab-icon">
            <div class="row">
              <div class="col-lg-12 col-xl-12">
                ...
                $_13a_from = $empno;
                $_13a_frompos = _jobrec($empno, "jrec_position");
                $_13a_act = "";
                $_13a_violation = [];
                // $_13a_violation_desc="";
                $_13a_datetime = "";
    ...
    // $_13a_violation_desc=$_13a_r["13a_violation_desc"];
                    ...
                    if (!in_array($empno, $_13a_read) && !empty($empno)) {
                      $_13a_read[] = $empno;
                  ...
                  foreach ($hr_pdo->query("SELECT 13ar_id, 13ar_read FROM tbl_13a_reply WHERE 13ar_13aid='" . $_13a_id . "'") as $rep_r) {
                    ...
                    $reply_read = $rep_r['13ar_read'] != "" && in_array($empno, explode(",", $rep_r['13ar_read'])) ? 1 : 0;
                  }
                }
...
<?php } else { ?>
    ...
    <div class="panel panel-default" style="max-width: 1000px; min-width: 700px; margin: auto;">
      <div class="panel-heading">
        <span class="pull-right">
          <a href="?page=grievance" class="btn btn-default btn-mini"><i class="fa fa-list"></i></a>
          <?php if ($_13a_id != "" && (($empno == $_13a_from && $_13a_stat == "draft") || get_assign('grievance', 'review', $empno))) { ?>
            &emsp;|&emsp;<button class="btn btn-danger btn-mini" onclick="del_13a()"><i class="fa fa-trash"></i></button>
          <?php } ?>
        </span>
        <label></label>
      </div>
      <div class="panel-body" style="margin-top:10px;">
                  ...
                  <table>
                    <tr>
                      <td colspan="2">
                        ...
                        <?php if ($_13a_stat == "issued" && ($_13a_to == $empno || $_13a_issuedby == $empno)) { ?>
            ...
            <div class="form-group">
              ...
              <div class="col-md-12">
                ...
                if ($_13a_witness != "") {
                      ...
                      <table style="display: inline-grid;">
                        <tr>
                          <td>
                            ...
                            <?php if (($empno == $witnessval || $empno == $_13a_issuedby) && $_13a_stat == "refused") { ?>
                          ...
                          <td style="vertical-align: bottom;">
                            ...
                            <?php }
                            if ($signed_witness == 0 && ($empno == $witnessval || $empno == $_13a_issuedby)) { ?>
                  ...
                  ?>
                  <?php if ($_13a_issuedby == $empno && $_13a_stat == "refused") { ?>
          ...
          <form class="form-horizontal" id="form-13a">
            <fieldset <?= ($_13a_id != "" ? "disabled" : "") ?>>
              ...
              <div class="form-group">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <div class="col-md-9">
                      <?php if ((($_13a_stat == "draft" || $_13a_stat == "" || $_13a_stat == "needs explanation") && $_13a_from == $empno) || (get_assign('grievance', 'review', $empno) && ($_13a_stat == "draft" || $_13a_stat == "" || $_13a_stat == "pending" || $_13a_stat == "needs explanation"))) { ?>
                  ...
                  <table class="table table-bordered table-sm">
                    ...
                    <tbody id="violation-list">
                      ...
                      foreach ($sqlv->fetchall(PDO::FETCH_ASSOC) as $vv) {
                        ...
                        if ((($_13a_stat == "draft" || $_13a_stat == "" || $_13a_stat == "needs explanation") && $_13a_from == $empno) || (get_assign('grievance', 'review', $empno) && ($_13a_stat == "draft" || $_13a_stat == "" || $_13a_stat == "pending" || $_13a_stat == "needs explanation"))) {
              ...
              <div class="form-group">
                ...
                <label class="col-md-12 immediate-action <?= ($_13a_immediate_action == 1 ? "checked" : "") ?>>"><input type="checkbox" id="immediate_action" <?= ($_13a_immediate_action == 1 ? "checked" : "") ?>> Furthermore, considering the gravity of the said offense you are hereby placed under <b>PREVENTIVE SUSPENSION</b> effective immediately and for a period of fifteen (15) days while this matter is being investigated. Please turn over all accountabilities. Note that preventive suspension is not a penalty, but a part of the process of investigation.</label>
            ...
            <div class="form-group">
              ...
              <div class="col-md-7">
                <table>
                  <tr>
                    <td>
                      ...
                      <?php if ($sign_issued == "" && $empno == $_13a_issuedby && $_13a_stat == "checked") { ?>
                    ...
                    <td style="vertical-align: bottom;">
                      ...
                      <?php } ?>
                      <?php if ($sign_issued == "" && $_13a_stat == "checked" && $_13a_issuedby == $empno) { ?>
                ...
                <?php if (get_assign('grievance', 'review', $empno) && ($_13a_stat == "pending" || $_13a_stat == "needs explanation")) { ?>
                  ...
                  <table>
                    <tr>
                      <td>
                        ...
                        <?php if ($_13a_stat == "checked" && $sign_issued != "" && $empno == $notedval && $_13a_stat == "checked") { ?>
        ...
        <div align="center">
          <?php if ((($_13a_stat == "draft" || $_13a_stat == "needs explanation") && $_13a_from == $empno) || $_13a_id == "") { ?>
          ...
          <?php } else if($_13a_id != "" && get_assign('grievance', 'review', $empno) && ($_13a_stat == "draft" || $_13a_stat == ""  || $_13a_stat == "pending" || $_13a_stat == "needs explanation")) { ?>
            <button id="btn-save-13a" class="btn btn-primary" style="<?= ($_13a_id != "" ? "display: none;" : "") ?>">Save</button>
          ...
          <?php if ($_13a_stat == "pending" && (get_assign('grievance', 'review', $empno) || $_13a_issuedby == $empno)) { ?>
            <!-- <button id="btn-edit-13a" class="btn btn-success" style="<?= ($_13a_id == "" ? "display: none;" : "") ?>">Edit</button> -->
            <!-- <button id="btn-save-13a" class="btn btn-primary" style="<?= ($_13a_id != "" ? "display: none;" : "") ?>">Save</button> -->
          <?php } ?>
        </div>
          ...
          <table class="table">
            <thead>
              <tr>
                ...
                <th>
                  <?php if ($_13a_id != "" && get_assign('grievance', 'review', $empno)) { ?>
                    <button class="btn btn-mini btn-primary" onclick="$('#otheriryModal').modal('show');">Attach IR</button>
                  <?php } ?>
                </th>
              </tr>
              <!-- <tr>
            ...
            <tbody>
              ...
              foreach ($hr_pdo->query("SELECT ir_id, ir_subject, ir_date FROM tbl_ir WHERE FIND_IN_SET( ir_id, '$_13a_ir' )>0") as $ir_r) { ?>
                <tr>
                  ...
                  <td>
                    <a href="?page=ir&no=<?= $ir_r["ir_id"] ?>" class="btn btn-info btn-mini"><i class="fa fa-eye"></i></a>
                    <?php if ($_13a_id != "" && get_assign('grievance', 'review', $empno)) { ?>
                      <button class="btn btn-danger btn-mini" onclick="del_otherir('<?= $ir_r["ir_id"] ?>')"><i class="fa fa-times"></i></button>
                    <?php } ?>
                  </td>
                </tr>
              <?php } ?>
        ...
        <div class="pull-right">
          <?php if (($_13a_issuedby == $empno || get_assign('grievance', 'review', $empno)) && in_array($_13a_stat, ['received', 'pending', 'reviewed', 'issued', 'checked'])) { ?>
            <button class="btn btn-sm btn-danger" onclick="$('#cancelModal').modal('show')">Cancel</button>
          <?php } ?>
          <?php if ($_13a_id != "" && in_array($_13a_stat, ["issued", "received", "refused"]) && ($empno == $_13a_to || $reply_id != "")) { ?>
          ...
          <?php } ?>
          <?php if (($_13a_issuedby == $empno || get_assign('grievance', 'review', $empno)) && $_13a_stat == "received") { ?>
          ...
          <?php } ?>
          <?php if ($_13a_hearing_loc == "" && $_13a_hearing_time == "" && ($_13a_issuedby == $empno || $commit_id != "" || get_assign('grievance', 'review', $empno)) && $_13a_stat == "received") { ?>
            <a href="?page=commitment-plan&_13a=<?= $_13a_id ?>" class="btn btn-default">Commitment Plan</a>
          <?php } ?>

          <?php if ($_13a_stat == "pending" && get_assign('grievance', 'review', $empno)) { ?>
          ...
          <?php } else if ($_13a_stat == "checked" && $sign_issued != "" && $signed_noted == 0 && in_array($empno, $arr_noted)) { ?>
          ...
          <?php } else if ($_13a_stat == "reviewed" && ($_13a_issuedby == $empno || get_assign('grievance', 'review', $empno))) { ?>
            <button type="button" class="btn btn-primary" onclick="issue_13a()">Issue</button>
          <?php } else if (($_13a_stat == "issued" || $_13a_stat == "received" || $_13a_stat == "refused") && get_assign('grievance', 'review', $empno) && $_13b_id == "") { ?>
            <a href="?page=13b&13a=<?= $_13a_id ?>" class="btn btn-primary">Create 13B</a>
          <?php }
          if ($_13a_stat == "issued" && ($empno == $_13a_to || $_13a_issuedby == $empno)) { ?>
  ...
  <?php if (($sign_issued != "" && $_13a_stat == "checked" && $signed_noted == 0 && in_array($empno, $arr_noted)) || ($sign_issued == "" && $_13a_stat == "checked" && $empno == $_13a_issuedby) || ($_13a_stat == "refused" && $signed_witness == 0 && in_array($empno, $arr_witness)) || ($_13a_stat == "issued" && ($empno == $_13a_to || $empno == $_13a_issuedby))) { ?>
