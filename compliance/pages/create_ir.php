          ...
          <div class="panel panel-default" style="border: 1px solid #a59e9e !important;">
            <div class="panel-heading">
              <span class="pull-right">
                <a href="ir" class="btn btn-default btn-sm"><i class="fa fa-list"></i></a>
                ...
                <form class="form-horizontal" id="form-ir">
                  <fieldset <?=($ir_id!="" ? "disabled" : "")?>>
                    ...
                    <div class="form-group" style="display:flex;">
                      ...
                      <div class="col-md-7">
                        <input type="text" name="" value="<?=date("F d, Y",strtotime($ir_date))?>" readonly>
                    ...
                    <div class="form-group equal" style="display: flex;justify-content: space-around;">
                      <div class="col-md-4">
                  ...
                  <?php //if($ir_id==""){ ?>
                    <div class="form-group">
                      <div class="col-md-12" align="right">
                        ...
                        <button id="btn-save-ir" type="button" class="btn btn-primary" style="<?=($ir_id!="" ? "display: none;" : "")?>">Save</button>
