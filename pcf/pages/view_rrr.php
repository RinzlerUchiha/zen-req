                              ...
                              foreach ($repl as $r) {
                                $replIDs = explode(',', $r['repl_pending']);
                                          ...
                                          <tr>
                                            ...
                                            <td style="border: 1px solid #ddd; padding: 5px;"></td>
                                            <td style="border: 1px solid #ddd; padding: 5px;"></td>
                                            <td style="border: 1px solid #ddd; padding: 5px;width: 100px;text-align: right;" id="balance"><i class="icofont icofont-cur-peso" style="font-size: 18px;"></i><?=number_format($rr['repl_end_balance'],2)?></td>
                                          </tr>
                                          <tr>
                                            <td style="border: 1px solid #ddd; padding: 5px;"></td>
